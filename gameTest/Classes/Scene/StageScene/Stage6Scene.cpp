...
void Stage6Scene::initCharactors()
{
    ...
    // 敵キャラクター
    EnemySprite* enemy1 = EnemySprite::create("enemy1.png", Vec2(9.0f, 26.0f), ::left, 0.1f, patorol_rotate);
    ...
    EnemySprite* enemy3 = EnemySprite::create("enemy1.png", Vec2(12.0f, 24.0f), ::left, 0.1f, patorol_rotate);
